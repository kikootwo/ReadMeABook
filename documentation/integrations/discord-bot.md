...
- `embeds.ts` — embeds, select menus, buttons (severity colors match the notification provider); request-card status footer/color/cancellability helpers.
