  ...
  return requireAuth(request, async (req: AuthenticatedRequest) => {
    ...
    const settings = {
      ...
      paths: {
        ...
        metadataWriteMode: configMap.get('metadata_write_mode') || process.env.RMAB_METADATA_WRITE_MODE || 'embedded',
        filePlacementMode: configMap.get('file_placement_mode') || process.env.RMAB_FILE_PLACEMENT_MODE || 'copy',
        hardlinkFallbackMode: configMap.get('hardlink_fallback_mode') || process.env.RMAB_HARDLINK_FALLBACK_MODE || 'copy',
